...
class class_blogger{
    ...
    function post($type,$postvalue){
        switch($type){
        // Ameblog
        case SYSTEM_BLOG_AMEBA:         return $this->postAmeba($postvalue);  break;
        // FC2
        case SYSTEM_BLOG_FC2:           return $this->postLivedoor($postvalue);  break;
        // ライブドア
        case SYSTEM_BLOG_LIVEDOOR:      return $this->postFC2($postvalue);  break;
        // Wordpress
        case SYSTEM_BLOG_WORDPRESS:     return $this->postWordpress($postvalue);  break;
        }
        return false;
    }
    // アメーバ投稿
